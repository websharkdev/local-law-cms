...
export interface ApiBlogArticleBlogArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.Relation<"manyToOne", "api::lawyer.lawyer">;
...
export interface ApiDocumentTemplateDocumentTemplate
  ...
  info: {
    description: "Document type: form fields + generation endpoint";
  ...
  attributes: {
    ...
    fields: Schema.Attribute.Component<"doc.field", true>;
    generationMethod: Schema.Attribute.Enumeration<["POST", "GET"]> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"POST">;
    generationPayloadTemplate: Schema.Attribute.JSON;
    generationUrl: Schema.Attribute.String;
...
export interface ApiHolidayHoliday extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Public holidays \u2014 apply to all lawyers and the notary";
    displayName: "Holiday";
    pluralName: "holidays";
...
export interface ApiLegalCategoryLegalCategory
  extends Struct.CollectionTypeSchema {
  collectionName: "legal_categories";
  info: {
    description: "Practice areas used for lawyer specializations and consultation requests";
    displayName: "Legal Category";
    pluralName: "legal-categories";
    singularName: "legal-category";
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiMenuMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    footerMenu: Schema.Attribute.Component<"shared.menu-link", true>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::menu.menu">;
    mainMenu: Schema.Attribute.Component<"shared.menu-link", true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
...
export interface ApiNotaryConfigNotaryConfig extends Struct.SingleTypeSchema {
  collectionName: "notary_configs";
  info: {
    description: "Working hours and booking rules for the notary service";
    displayName: "Notary Config";
    pluralName: "notary-configs";
    singularName: "notary-config";
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    blackoutDates: Schema.Attribute.Component<"schedule.blackout-date", true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::notary-config.notary-config"
    > &
      Schema.Attribute.Private;
    maxDaysAhead: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        },
    ...
    timezone: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"Asia/Dubai">;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    workingDays: Schema.Attribute.Component<"schedule.working-day", true>;
  };
}

export interface ApiNotaryServiceNotaryService
  extends Struct.CollectionTypeSchema {
  collectionName: "notary_services";
  info: {
    description: "Services available for notary booking";
    displayName: "Notary Service";
    pluralName: "notary-services";
    singularName: "notary-service";
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Static landing pages with blocks";
    displayName: "Page";
    pluralName: "pages";
    singularName: "page";
  };
...
export interface ApiPricingPricing extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Service prices used by the app when charging customers";
    displayName: "Pricing";
    pluralName: "pricings";
...
export interface ApiServicePricingServicePricing
  ...
  info: {
    description: "Price list items per service";
...
export interface ApiSiteSettingsSiteSettings extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Global site settings \u2014 brand, contact, social links";
...
export interface ApiTranslationRequestTranslationRequest
  ...
  info: {
    description: "Legal translation requests submitted from the app";
  ...
  attributes: {
    ...
    files: Schema.Attribute.Component<"req.file", true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      "oneToMany",
    ...
    totalAmountAed: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
